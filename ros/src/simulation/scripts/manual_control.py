...
class World(object):
    ...
    def restart(self):
        ...
        # todo: this code is not pretty. start all other sensors
        self.camera_manager.set_sensor(2)
        self.camera_manager.set_sensor(5)
        self.camera_manager.set_sensor(6)
    ...
    def destroy(self):
        actors = [self.camera_manager.sensor,
...
def game_loop():
    ...
    try:
        ...
        controller = KeyboardControl(world, autopilot)
