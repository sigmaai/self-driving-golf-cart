...
echo_and_run cd "/home/yongyang/Workspace/self-driving-golf-cart/src/osm_cartography"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/yongyang/Workspace/self-driving-golf-cart/src/osm_cartography/setup.py" \
    build --build-base "/home/yongyang/Workspace/self-driving-golf-cart/build/osm_cartography" \
    install \
    $DESTDIR_ARG \
