...
echo_and_run cd "/home/neil/Workspace/self-driving-golf-cart/src/simulation"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/neil/Workspace/self-driving-golf-cart/src/simulation/setup.py" \
    build --build-base "/home/neil/Workspace/self-driving-golf-cart/build/simulation" \
    install \
    $DESTDIR_ARG \
