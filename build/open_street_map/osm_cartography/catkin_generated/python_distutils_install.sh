...
echo_and_run cd "/home/neil/Workspace/self-driving-golf-cart/src/open_street_map/osm_cartography"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/neil/Workspace/self-driving-golf-cart/src/open_street_map/osm_cartography/setup.py" \
    build --build-base "/home/neil/Workspace/self-driving-golf-cart/build/open_street_map/osm_cartography" \
    install \
    $DESTDIR_ARG \
