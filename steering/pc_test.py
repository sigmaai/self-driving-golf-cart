#
# Test the autnomous steering control system
# on a person computer running Linux. 
# This code is largly based on steering_visualizer.py
# (c) Neil Nie, Michael Meng 
#
