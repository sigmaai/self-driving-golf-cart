...
if("TRUE" STREQUAL "TRUE")
  set(rviz_satellite_SOURCE_PREFIX /home/yongyang/Workspace/self-driving-golf-cart/src/gps_viz)
  set(rviz_satellite_DEVEL_PREFIX /home/yongyang/Workspace/self-driving-golf-cart/devel)
  ...
  set(rviz_satellite_INSTALL_PREFIX /home/yongyang/Workspace/self-driving-golf-cart/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rviz_satellite' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/yongyang/Workspace/self-driving-golf-cart/src/gps_viz/${idir}'.  ${_report}")
    endif()
