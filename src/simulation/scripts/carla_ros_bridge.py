...
class CarlaROSBridge(object):
    ...
    def compute_camera_sensor_msg(self, name, sensor):
        ...
        if sensor.type == 'Depth':
            # ROS PEP 0118 : Depth images are published as sensor_msgs/Image encoded
            # as 32-bit float. Each pixel is a depth (along the camera Z axis) in meters.
