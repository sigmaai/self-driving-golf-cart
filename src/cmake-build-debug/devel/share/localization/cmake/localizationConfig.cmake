...
if("TRUE" STREQUAL "TRUE")
  set(localization_SOURCE_PREFIX /home/yongyang/Workspace/self-driving-golf-cart/src/localization)
  set(localization_DEVEL_PREFIX /home/yongyang/Workspace/self-driving-golf-cart/src/cmake-build-debug/devel)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'localization' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/yongyang/Workspace/self-driving-golf-cart/src/localization/${idir}'.  ${_report}")
    endif()
