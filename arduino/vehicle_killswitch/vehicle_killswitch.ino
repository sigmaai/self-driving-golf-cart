...
void loop() {
  ...
  if (receiver_input_channel_5 >= 1700) {
...
ISR(PCINT0_vect) {
  ...
  //Channel 5=========================================
  if (last_channel_5 == 0 && PINB & B00010000 ) {       //Input 11 changed from 0 to 1
    last_channel_5 = 1;                                 //Remember current input state
    timer_5 = micros();                                 //Set timer_4 to micros()
  }
  else if (last_channel_5 == 1 && !(PINB & B00010000)) { //Input 11 changed from 1 to 0
    last_channel_5 = 0;                                 //Remember current input state
    receiver_input_channel_5 = micros() - timer_5;      //Channel 4 is micros() - timer_4
  }
}
